...
#define LOG_ERROR(m) { \
 char L_err [2000] ; \
 snprintf(L_err, 2000, (char*)(m)) ; \
(*m_logError)(L_err); \
}

#define LOG_ERROR_P1(m,P1) { \
 char L_err [2000] ; \
 snprintf(L_err, 2000, (char*)(m), (P1)) ; \
(*m_logError)(L_err); \
}

#define LOG_ERROR_P2(m,P1,P2) { \
 char L_err [2000] ; \
 snprintf(L_err, 2000, (char*)(m), (P1),(P2)) ; \
(*m_logError)(L_err); \
}
...
#define LOG_ALL(m) { \
 char L_msg [2000] ; \
 snprintf(L_msg, 2000, (char*)(m)) ; \
(*m_logInfo)(L_msg); \
}

#define LOG_ALL_P1(m,P1) { \
 char L_msg [2000] ; \
 snprintf(L_msg, 2000, (char*)(m), (P1)) ; \
(*m_logInfo)(L_msg); \
}

#define LOG_ALL_P2(m,P1,P2) { \
 char L_msg [2000] ; \
 snprintf(L_msg, 2000, (char*)(m), (P1),(P2)) ; \
(*m_logInfo)(L_msg); \
}
